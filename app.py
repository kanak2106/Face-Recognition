...
if choose == "About":
    ...
    with col1:               # To display the header text using css style
        ...
        st.markdown('In this application we are using OpenCV and face_recognition module for creating a **Face Recognition Application** . **Streamlit** is to create the Web Graphical User Interface (GUI). ')
    st.markdown(
    """
    <style>
    ...
    st.markdown('''
          # About Me \n 
            Hey this is **Kanak Gautam** . \n
            
            Also check us out on Social Media
            
            - [LinkedIn](https://www.linkedin.com/in/kanak-gautam-66302a202/)
            - [GitHub](https://github.com/kanak2106)     
            ''')  
